...
class CharacterData01 extends CharacterData {
  ...
  // java GenerateCharacter -plane 1 -template j:/jenkins/tmp/workspace/build/src/jdk/make/data/characterdata/CharacterData01.java.template -spec j:/jenkins/tmp/workspace/build/src/jdk/make/data/unicodedata/UnicodeData.txt -specialcasing j:/jenkins/tmp/workspace/build/src/jdk/make/data/unicodedata/SpecialCasing.txt -proplist j:/jenkins/tmp/workspace/build/src/jdk/make/data/unicodedata/PropList.txt -o j:/jenkins/tmp/workspace/build/src/build/windows-x86_64-normal-server-release/jdk/gensrc/java/lang/CharacterData01.java -string -usecharforbyte 11 4 1
